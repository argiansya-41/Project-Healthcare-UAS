...
@section('content')
    <div class="card">
        ...
        <!-- Filter bar -->
        <form action="{{ route('apotek.transactions.index') }}" method="GET" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(150px, 1fr)); gap: 16px; margin-bottom: 24px;">
