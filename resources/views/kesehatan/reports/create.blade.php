...
@section('content')
    <div class="card" style="max-width: 850px; margin: 0 auto;">
        <div style="margin-bottom: 24px; display: flex; align-items: center; gap: 12px;">
            ...
            <h3 style="font-size: 18px; font-weight: 700;">Formulir Pelaporan Penyakit</h3>
        </div>
        ...
        <form action="{{ route('kesehatan.reports.store') }}" method="POST">
            @csrf
            ...
            <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 20px;">
                ...
                <h4 style="grid-column: span 2; font-size: 15px; font-weight: 700; border-bottom: 1px solid var(--card-border); padding-bottom: 8px; margin-top: 20px; color: var(--accent-color);">
                    <i class="ri-microscope-line"></i> Diagnosis Kasus & Lokasi
                </h4>

                <div class="form-group">
                    <label for="disease_type_id">Jenis Penyakit (Diagnosis Awal)</label>
                ...
                <div class="form-group">
                    ...
                    <select id="severity" name="severity" class="form-control" style="appearance: none; background-image: url('data:image/svg+xml;utf8,<svg fill=\'%2364748b\' height=\'24\' viewBox=\'0 0 24 24\' width=\'24\' xmlns=\'http://www.w3.org/2000/svg\'><path d=\'M7 10l5 5 5-5z\'/><path d=\'M0 0h24v24H0z\' fill=\'none\'/></svg>'); background-repeat: no-repeat; background-position: right 12px center; background-size: 16px;" required>
                        ...
                        <option value="sedang" {{ old('severity') == 'sedang' ? 'selected' : '' }}>Sedang (Membutuhkan Pengawasan Medis)</option>
                        <option value="berat" {{ old('severity') == 'berat' ? 'selected' : '' }}>Berat (Membutuhkan Perawatan Intensif)</option>
                    </select>
                </div>

                <div class="form-group" style="grid-column: span 2;">
                    <label for="report_date">Tanggal Mulai Sakit / Tanggal Lapor</label>
                ...
                <div class="form-group" style="grid-column: span 2;">
                    <label for="village_id">Pilih Wilayah (Desa, Kecamatan, Kabupaten)</label>
                ...
                <div class="form-group" style="grid-column: span 2;">
                    <label for="symptoms">Detail Gejala yang Dialami Pasien</label>
                ...
                <button type="submit" class="btn btn-primary" style="grid-column: span 2; justify-content: center; padding: 14px; margin-top: 10px;">
                    <i class="ri-send-plane-fill"></i> Kirim Laporan Penyakit
                </button>
            </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Run on initial load if old value exists
